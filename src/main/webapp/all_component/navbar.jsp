	...
	<div class="row">
		...
		<c:if test="${not empty userobj }">
			...
			<div class="col-md-3">
				...
				<a href="cart.jsp"><i class="fas fa-shopping-cart fa-2x "></i> </a><a
					href="login.jsp" class="btn btn-success"><i
					class="fas fa-user-plus"></i>&nbsp ${userobj.name }</a> <a href="logout"
					class="btn btn-primary text-white"> <i
					class="fas fa-sign-in-alt"></i>&nbsp Logout
				</a>
			</div>
		</c:if>
