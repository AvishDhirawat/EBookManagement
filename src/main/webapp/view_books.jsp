	...
	<div class="container p-3">
		<div class="row">
			...
			<div class="col-md-6 text-center p-5 border bg-white">
				...
				<a href="index.jsp" class="btn btn-primary"><i class="fas fa-shopping-cart"></i>
...
<%} else { %>
				<div class="text-center p-3">
					<a href="cart?bid=<%=b.getBookId() %>&&uid=<%=u.getId() %>" class="btn btn-primary"><i class="fas fa-cart-plus"></i>Add
